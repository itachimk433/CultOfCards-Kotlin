...
data class GameRun(
    ...
    val swordsmanRank: SwordsmanRank = SwordsmanRank.NOVICE,
    val manaBonus: Int = 0
)
...
class GameRepository(context: Context) {
    ...
    private val prefs = context.getSharedPreferences("cult_of_cards_sword", Context.MODE_PRIVATE)
    private val gson = Gson()

    companion object {
        private const val KEY_RUN    = "run_sword_v1"
        private const val KEY_QUESTS = "quests_sword_v1"
        private const val KEY_GLOBAL = "global_sword_v1"
    }
